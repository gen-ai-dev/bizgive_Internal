...
config_data = {"top_k":3,"embeddings_model":os.getenv("EMBEDDING_MODEL")}  

def get_reference(query: str, collection_id:str, projectCollection:str,industryCollection:str,type: Optional[str] = None) -> List[Dict[str, Any]]:
    """
...
def lambda_handler(event, context):
    ...
    try:
        ...
        projectCollection = event.get("projectCollection") 
        industryCollection = event.get("industryCollection")
