...
def initialize_llm(model_id: str, temperature: float, max_tokens: int = 500):
    """
    ...
    try:
        ...
        logger.info(f"Bedrock LLM initialized with model: {model_id}, temperature: {temperature}, max_tokens: {max_tokens}")
        return llm
